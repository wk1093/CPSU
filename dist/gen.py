#
# cpsudir = "src/cpsu"
# outfile = "dist/cpsu/cpsu.h"
# beginf = "_cpsu_include.h"
# endf = "_cpsu_end.h"
#
# import os
# import sys
#
# def main():
#     # combine a bunch of headers and source files into one header
#     # format:
#     # header guard
#     # include begin
#     # header sources
...
#
#     # recurse
#     for root, dirs, files in os.walk(cpsudir):
#         for f in files:
#             if f.endswith(".h"):
#                 if f == beginf:
...
#                 else:
#                     with open(os.path.join(root, f), "r") as h:
#                         header_source += h.read() + "\n"
#             elif f.endswith(".c"):
#                 with open(os.path.join(root, f), "r") as c:
#                     source_source += c.read() + "\n"
#
#     # write
#     with open(outfile, "w") as out:
#         out.write("#ifndef _CPSU_H\n")
#         out.write("#define _CPSU_H\n")
#         out.write(begin)
#         out.write(header_source)
#         out.write("#ifdef _CPSU_IMPLEMENTATION\n")
#         out.write(source_source)
#         out.write("#endif\n")
#         out.write(end)
#         out.write("#endif\n")
#
